    ...
    for PRnum in PRlist:
        ...
        if PRnum==primary:
            ...
            if pri in PRdictCached.keys() and (PRdictCached[pri]["merged"] or PRdictCached[pri]["closed"]):
                ...
                elif PRdict[pri]["closed"] and not PRdict[pri]["merged"]: num_closed += 1
                skip = True
                continue
...
# print summary
print str(len(PRs))+" PRs, "+str(num_merged)+" merged, "+str(num_closed)+" closed"
